-- Fix: Update BOTH total_earnings AND monthly_earnings when completing orders
-- This ensures direct bookings and normal bookings both update earnings correctly
