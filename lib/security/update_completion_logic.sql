-- Improve complete_order_and_pay to fallback to user_price if price is NULL
-- This ensures earnings are added even if the final price wasn't explicitly copied to the price column.
