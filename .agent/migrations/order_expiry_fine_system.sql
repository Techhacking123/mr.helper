-- =====================================================
-- ORDER EXPIRY FINE SYSTEM - Complete Database Migration
-- =====================================================
-- This migration implements a fine system for expired orders
-- Fine: ₹50 per expired order
-- Expiry: 24hr deadline + 24hr extensions per "Working" click
-- =====================================================

-- Step 1: Add Fine Tracking Columns to orders table
...
-- Step 2: Add Fine Tracking to users table (for providers)
...
-- Step 3: Create Fine Transactions Table
...
-- Step 4: Function to Update Provider Total Fines
...
-- Step 5: Function to Set Initial Deadline (on order creation)
...
-- Step 6: Update existing orders to have deadlines
UPDATE orders
SET 
...
-- Step 7: RPC Function to Extend Order Deadline (when "Working" clicked)
...
-- Step 8: RPC Function to Check & Mark Expired Orders
...
-- Step 9: RPC Function to Get Provider's Unpaid Fines
...
-- Step 10: RPC Function to Pay Fine (separate payment)
...
-- Step 11: RPC Function to Pay Fines with Subscription
...
-- Step 12: Grant permissions for RPC functions
...
-- Step 13: RLS Policies for fine_transactions table
...
-- Step 14: Create view for provider fine summary
CREATE OR REPLACE VIEW provider_fine_summary AS
SELECT 
  u.id as provider_id,
...
-- Then implement Flutter frontend changes
-- =====================================================
